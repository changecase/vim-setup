...
if has("autocmd")
  ...
  augroup squarespaceGroup
    ...
    " Automatically highlight Squarespace files
    autocmd BufNewFile,BufRead */sqs_template/*.conf set ft=javascript
...
" stop generating backup files on save (those *~ things)
set nobackup

" enable code folding on Javascript files
